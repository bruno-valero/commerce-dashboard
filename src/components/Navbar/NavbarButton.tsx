...
export default function NavbarButton({ title, icon, color, dotColor, customFunc }:NavbarButtonProps) {
  return (
    <ToolTipClientComponent content={title} position='BottomCenter' className='my-auto' >
      <button type='button' onClick={customFunc} className={`${color} relative text-xl rounded-full p-3 hover:bg-gray-600`} >
