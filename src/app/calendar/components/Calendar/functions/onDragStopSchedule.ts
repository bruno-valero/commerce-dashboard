...
export default async function onDragStopSchedule(props:DragEventArgs & BaseURLDataState & {setInfo: SetState<Info>}):Promise<void> {
...
export type OnDragStopScheduleType = (props:DragEventArgs) => Promise<void>;