...
const customerGridStatus = (props:any) => (
  <div className="flex gap-2 justify-center items-center text-gray-700 capitalize">
    <div style={{backgroundColor: props.StatusBg}} className={`p-1 rounded-full`} />
    <p>{props.Status}</p>
  </div>
);
...
export const stackedChartData:RevenueReport = {
  budget: [
    { x: 'Jan', y: 8000 },
    { x: 'Fev', y: 6000 },
    { x: 'Mar', y: 9500 },
    ...
    { x: 'Jun', y: 8500 },
    { x: 'Jul', y: 12000 },
    { x: 'Ago', y: 20000 }, // Pico sazonal em agosto
    { x: 'Set', y: 10000 },
    { x: 'Out', y: 10500 },
    { x: 'Nov', y: 7500 },
    { x: 'Dez', y: 9000 },
  ...
  expense: [
    ...
    { x: 'Jun', y: 8500 },
    { x: 'Jul', y: 9000 },
    { x: 'Ago', y: 14000 }, // Aumento sazonal em agosto
    { x: 'Set', y: 10500 },
    { x: 'Out', y: 10000 },
    { x: 'Nov', y: 12000 },
    { x: 'Dez', y: 9500 },
...
export const stackedCustomSeries:StackedCustomSeriesType = [

  { dataSource: stackedChartData['budget'],
    xName: 'x',
    yName: 'y',
    name: 'Budget',
    type: 'StackingColumn',
  ...
  { dataSource: stackedChartData['expense'],
    xName: 'x',
    yName: 'y',
    name: 'Expense',
    type: 'StackingColumn',
    fill: 'rgba(150,150,150,.6)',
